    ...
    return (
        <div className='slider'>
            <Carousel autoPlay infiniteLoop showThumbs={false} showArrows>
                ...
                <div>
                    <p>Спасибо большое, очень рада, что именно к тебе пришла. С тобой очень комфортно.</p>
                </div>
                <div>
                ...
                <div>
                    <p className='slider__text_five'>Здравствуйте, хотела еще раз поблагодарить вас за проделанную работу. У предыдущих мастеров испытывала ужасный дискомфорт, а с вами прошло всё быстро и безболезненно))</p>
                </div>
                <div>
                    <p className='slider__text_six'>Спасибо большое. Вы лучшая <img src={smile_2} alt="smile_2" /> Очень довольна результатом.</p>
                </div>
            </Carousel >
        </div >
    )
